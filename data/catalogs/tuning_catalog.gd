...
static func _source_definitions() -> Array:
	return [
		...
		TuningValue.new("roundRecover", 2),
		TuningValue.new("enemyRoundRecover", 1),
		...
		TuningValue.new("ascendRepeatAtkBonus", 3.0),
		TuningValue.new("ascendRepeatBlockBonus", 0.03),
		TuningValue.new("ascendRepeatCritBonus", 0.03),

...
const DormantShentongTestScript = preload("res://tests/m5_dormant_shentong_test.gd")
const FullRunE2ETestScript = preload("res://tests/m5_full_run_e2e_test.gd")
...
func _run() -> void:
	...
	for suite_script in [
		...
		DormantShentongTestScript,
		FullRunE2ETestScript,
	]:

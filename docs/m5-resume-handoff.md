...
> M5 已于 2026-09-08 完成并通过 M5-90 独立 Review。本文件仅保留换设备前后的历史过程证据，不再是当前启动入口。运行、测试与继续开发请先读 [`playable-handoff.md`](playable-handoff.md)；M5 领域边界的历史细节再查 [`m5-handoff.md`](m5-handoff.md) 与 [`迁移现状与后续路线-2026-09-08.md`](迁移现状与后续路线-2026-09-08.md)。不要按本文旧步骤重新启动 M5-04～06。
